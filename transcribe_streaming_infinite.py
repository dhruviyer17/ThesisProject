...
# Initialization of Google Image Search API
gis = GoogleImagesSearch('AIzaSyCXJ9adSwAtUxW5zMHB45Z2q4d0fuMuI2M', '60f513da817364075')
yss = pyyoutube.api('AIzaSyCXJ9adSwAtUxW5zMHB45Z2q4d0fuMuI2M')
...
def listen_print_loop(responses):
    ...
    for response in responses:
        ...
        if not result.is_final:
            ...
            my_bytes_io = BytesIO()
            gis.search({'q': transcript + overwrite_chars, 'num': 1})
            yss.search_by_keywords()
